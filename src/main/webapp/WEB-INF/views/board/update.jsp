                    ...
                    <div class="col-lg-11 col-xl-9 col-xxl-8">
                    	<form class="form-control" action="./update" method="POST" enctype="multipart/form-data">
                    		<input type="hidden" name="boardNum" value="${boardDTO.boardNum}"/>
							  ...
							  <input type="text" class="form-control" id="title" name="boardHead" value="${boardDTO.boardHead}">
							</div>
                            <div class="mb-3">
                                <label for="writer" class="form-label">Writer</label>
                                <input type="text" readonly="readonly" class="form-control" id="writer" name="boardWriter" value="${boardDTO.boardWriter}">
                            </div>
							<div class="mb-3">
