					...
					<div class="card my-3">
						...
						<div class="row card-body">
							...
							<div class="card-footer text-muted">
								<div class="row justify-content-center">
									<div class="row align-self-center bg-light rounded-4">
										<button id="update"
											class="col me-3 btn btn-dark w-100 py-2 mt-2" type="submit">회원정보수정</button>
										<button id="delete" class="col btn btn-dark w-100 py-2 mt-2"
