...
<nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
	<div class="container px-5">
		<a class="navbar-brand" href="/"><span
			class="fw-bolder text-primary">Home</span></a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
				...
				<c:if test="${not empty member}">
					<li class="nav-item"><a class="nav-link" href="/account/list">My
							Account</a></li>
				</c:if>
			</ul>
			<ul class="navbar-nav ms-m mb-2 mb-lg-0 small fw-bolder">
				<c:if test="${empty sessionScope.member}">
					...
					<li class="nav-item"><a class="nav-link"
						href="/member/agreement">Sign Up</a></li>
				</c:if>
				<c:if test="${not empty sessionScope.member}">
					<li class="nav-item"><a class="nav-link" href="/member/mypage">My
							page</a></li>
